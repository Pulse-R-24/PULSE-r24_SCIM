...
export function FeaturedPublishedReport({ report }: { report?: PublicReportSummary }) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <Link href={getReportHref(report)} className="group grid overflow-hidden rounded-[2rem] border border-slate-900/10 bg-white shadow-xl shadow-slate-950/5 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="p-8 lg:p-10">
          ...
          <h2 className="mt-5 text-3xl font-black leading-tight tracking-tight text-slate-950 group-hover:text-rose-800 lg:text-4xl">
            {report.title}
          </h2>
