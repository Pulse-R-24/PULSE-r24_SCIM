...
export function PublicFooter() {
  return (
    <footer className="mt-20 border-t border-white/10 bg-[#070b24] px-4 py-14 text-white sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
        <section>
          <h2 className="text-4xl font-black tracking-tight text-rose-700">
