  ...
  return (
    <header className="border-b border-slate-200 bg-slate-50">
      <div className="mx-auto max-w-4xl px-4 pb-10 pt-10 sm:px-6 lg:px-8">
        ...
        <Link href="/news" className="mb-6 inline-flex items-center gap-2 text-sm font-semibold text-slate-500 transition hover:text-[#8b0000]">
          <ChevronLeft className="h-4 w-4" /> Return to Intelligence Feed
        </Link>
        ...
        <h1 className="font-editorial text-4xl font-black leading-tight tracking-tight text-slate-950 sm:text-5xl">{report.title}</h1>
